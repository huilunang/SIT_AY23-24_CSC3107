...
Reading of **Total Annual Greenhouse Gas Emissions Dataset**
...
Reading of **Greenhouse Gas Emissions Per Capita Dataset**
...
Remove NAs and renamed column from **Total Annual Greenhouse Gas Emissions Dataset**

```{r}
#| echo: false

# Rename the total emissions column
colnames(totalGHG)[colnames(totalGHG) == "Annual.greenhouse.gas.emissions.in.CO..equivalents"] <- "Total C02 Emissions (t)"

# Display total GHG emission column as a whole number
totalGHG$"Total C02 Emissions (t)" <- as.integer(totalGHG$"Total C02 Emissions (t)")

# Remove NAs from total emissions column
totalGHG_cleaned <- drop_na(totalGHG, "Total C02 Emissions (t)")
...
Remove NAs and renamed column from **Greenhouse Gas Emissions Per Capita Dataset**

```{r}
#| echo: false

# Rename the per capita emissions column
colnames(perCapitaGHG)[colnames(perCapitaGHG) == "Total.greenhouse.gas.emissions.per.capita.excluding.land.use.change.and.forestry"] <- "Per Capita C02 Emissions (t)"

# Remove NAs from per capita emissions column
perCapitaGHG_cleaned <- drop_na(perCapitaGHG, "Per Capita C02 Emissions (t)")
