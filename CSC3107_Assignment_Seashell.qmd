...
![Original Total Greenhouse Gas Emissions](original_chart/total_ghg_emissions_bbchart.png)
...
pal <- colorNumeric(palette = "YlOrRd", domain = world$per_capita_ghg_emissions_t)

# Add ranking and labels
world$label <- lapply(
  sprintf(
    "<strong>%d. %s</strong><br/>%s t",
    world$ranking, world$iso_a3_eh, prettyNum(world$per_capita_ghg_emissions_t, big.mark = ",")
  ), HTML
)
...
map <- leaflet() %>%
  ...
  setView(lng = 84.1240, lat = 28.3949, zoom = 2)
...
![Original Total Emissions Reduction Required](original_chart/percentage_reduction_required_1_5.png)
