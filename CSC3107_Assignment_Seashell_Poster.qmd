...
Because our visualization was designed for a poster, interactive features were not included. However, we would like to suggest the following recommendations for enhancing interactivity. Include a time slider to visualize changes in greenhouse gas emissions and reduction targets over different years. This allows users to see trends and progress over time interactively. Enable zoom and pan functionality to allow users to explore specific regions in more detail. This is especially useful for closely examining areas with dense or high-emission data points.
